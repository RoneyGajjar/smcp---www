...
import { login } from "@/app/login/action" // Import the Server Actions
import Link from "next/link"

// Added a message prop to catch authentication errors
        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          <form className="p-6 md:p-8">
            <FieldGroup>
              ...
              {message && (
                <div className="bg-destructive/10 text-destructive text-sm font-bold p-3 rounded-md text-center border border-destructive/20">
                  {message}
                </div>
              )}
              ...
              <Field>
                ...
                <Input
                  id="email"
                  name="email" // CRITICAL: Required for Server Actions to read the input
                  type="email"
              ...
              <Field>
                ...
                <Input
                  id="password"
                  name="password" // CRITICAL: Required for Server Actions to read the input
                  type="password"
                  required
                />
              </Field>
              ...
              <FieldDescription className="text-center flex items-center justify-center gap-1 mt-2">
                Don&apos;t have an account?
                <Link href="/signup" className="underline hover:text-primary font-medium transition-colors">
                  Sign up
                </Link>
              </FieldDescription>
            </FieldGroup>
