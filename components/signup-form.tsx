...
import { signup } from "@/app/login/action" // Import the Server Action

export function SignupForm({
  className,
  message, // Added message prop for error handling
  ...props
        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          <form className="p-6 md:p-8">
            <FieldGroup>
              ...
              {message && (
                <div className="bg-destructive/10 text-destructive text-sm font-bold p-3 rounded-md text-center border border-destructive/20 mt-2">
                  {message}
                </div>
              )}
              ...
              <Field>
                ...
                <Input
                  id="email"
                  name="email" // CRITICAL: Required for FormData
                  type="email"
